...
enroll_button = tk.Button(root, text="Enroll", command= enroll_finger)

enroll_button.pack()

verify_button = tk.Button(root, text="Verify", command=verify_finger)
verify_button.pack()
